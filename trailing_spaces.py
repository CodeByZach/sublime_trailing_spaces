...
SETTINGS_FILENAME = 'TrailingSpaces.sublime-settings'
...
def highlight_trailing_spaces_regions(view, regions):
	...
	view.add_regions('TrailingSpacesHighlightedRegions', regions, current_highlight_color or "", "", sublime.HIDE_ON_MINIMAP)
